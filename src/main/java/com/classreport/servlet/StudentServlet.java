...
public class StudentServlet extends HttpServlet {
	...
	public void init(ServletConfig sc) {
		System.out.println("initializing studentservlet...");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//<out.println("<body background-color=#e6e6fae8>")
			out.println("<html>");
			out.println("<head>");
			out.println("</head>");
			out.println("<body style=background-color:#e6e6fae8>");
			out.println("<p style=text-align:left;font-size:200%;>Details of Students:</p>");
