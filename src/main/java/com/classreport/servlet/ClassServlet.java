...
public class ClassServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("inside class servlet..");
		try {
			...
			out.println("<p style=text-align:left;font-size:200%;>Details of Classes:</p>");
			out.println("<table border=1>");
			out.println("<tr>");
			out.println("<th>Name</th>");
			out.println("<th>Section</th>");
			out.println("<th>Strength</th>");
			out.println("<th>CR</th>");
			out.println("<th>Faculty</th>");
